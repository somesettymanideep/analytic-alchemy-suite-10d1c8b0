...
function CustomersViewPremium() {
  ...
  const bento = [
    ...
    { span: "", icon: Cloud, title: "Microsoft Dynamics", desc: "D365 F&O Application Managed Services, Business Central, Power BI, Azure Data Factory — single and multi-country landscapes.", tag: "Powered by OrcaMigrate & Owlsight", gradient: "from-[#00C6FF]/10 to-[#2958FF]/10" },
...
export default function Edt() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-gradient-to-b from-[#d9e2fb] via-[#d9e2fb] to-background">
