...
import bannerStaffing from "@/assets/banners/banner-staffing.jpg";
import intelligenceVideo from "@/assets/industries/staffing-intelligence.mp4";
import expertiseImg from "@/assets/industries/staffing-expertise.jpg";
import { useScrollReveal } from "@/hooks/use-scroll-reveal";
import { ArrowRight, ChartLine, CheckCircle, Clock, Database, Gear, Scroll, Sparkle, UserCheck, Users } from "@phosphor-icons/react";
    ...
    <section className="container py-12 md:py-16" ref={ref}>
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div className={`relative order-2 lg:order-1 ${isVisible ? "animate-reveal-up" : "opacity-0"}`}>
          ...
          <img
            src={expertiseImg}
            alt="Global staffing team collaborating"
            loading="lazy"
            width={1280}
            height={896}
            className="relative w-full h-auto rounded-2xl shadow-xl border border-border/60 object-cover"
    ...
    <section className="section-alt py-12 md:py-16">
      <div className="container" ref={ref}>
        <div className={`max-w-2xl mx-auto text-center ${isVisible ? "animate-reveal-up" : "opacity-0"}`}>
          ...
          <h2 className="mt-4 text-3xl md:text-4xl font-bold text-foreground font-heading text-balance">
            Specialized toolsets for staffing transformation
          </h2>
          <p className="mt-4 text-muted-foreground leading-relaxed">
...
export default function Staffing() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        <PageBanner
          image={bannerStaffing}
          eyebrow="Industries · Staffing"
