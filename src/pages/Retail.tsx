...
import bannerRetail from "@/assets/banners/banner-retail.jpg";
import retailVideo from "@/assets/industries/retail-intelligence.mp4";
import wholesaleImg from "@/assets/industries/wholesale-intelligence.jpg";
import { useScrollReveal } from "@/hooks/use-scroll-reveal";
import { ArrowRight, ChartLine, CheckCircle, Database, Gauge, Gear, Graph, Package, Percent, Sparkle, Stack, Tote, UserPlus } from "@phosphor-icons/react";
      ...
      {(ctaErpHref || ctaD365Href) && (
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          ...
          {ctaD365Href && (
            ...
            >
              <ChartLine size={16} /> Explore Dynamics 365 services <ArrowRight size={16} />
            </Link>
          )}
        </div>
      )}
